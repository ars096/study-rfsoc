...
"""proj008（proj007 から変更なし）— LMK04828 の PLL1 基準を外部 10 MHz（CLK_IN の SMA）に切り替える。
...
そこで proj005 の検証は **2 系統の外側の証拠**で行う。
...
def find_stock_lmk_file():
    ...
    **proj006 にコピーを持たず、その場で読む。** ボードのイメージを焼き直したときに
